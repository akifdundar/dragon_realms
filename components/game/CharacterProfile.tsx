...
type CharacterProfileProps = {
  ...
  onLevelUp: () => void;
  onEnhanceIntelligence: () => void;
  isLevelingUp: boolean;
  canEnhanceIntelligence: boolean;
};
...
export const CharacterProfile = ({
  ...
  onLevelUp,
  onEnhanceIntelligence,
  isLevelingUp,
  canEnhanceIntelligence,
          ...
          <Card className="bg-slate-900/70 border-slate-700 backdrop-blur-xl shadow-2xl shadow-purple-500/10">
            ...
            <CardContent className="space-y-6">
              ...
              >
                <Button
                  onClick={
                    canEnhanceIntelligence ? onEnhanceIntelligence : onLevelUp
                  }
                ...
                >
                  <motion.div
                    ...
                    transition={{
                      duration: 1.5,
                      repeat: isLevelingUp ? Number.POSITIVE_INFINITY : 0,
                    }}
                  />
